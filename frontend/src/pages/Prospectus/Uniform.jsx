...
export default function RulesPage() {
  ...
  /* ---------- Stable Scroll Spy (NO layout break) ---------- */
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <aside className="hidden lg:block w-72">
        <div className="lg:my-28 fixed top-0 left-0 h-screen w-72 px-6">
      ...
      {/* ================= MAIN CONTENT ================= */}
      <main className="flex-1 ml-0 lg:my-12">
       <div className="max-w-7xl mx-48 px-8">
